...
export const taxonomy = {
  ...
  affiliation: [
    { id: "2", label: "新星学園",     short: "新星", icon: P + "affiliation_01.png" },
    { id: "1", label: "流星学園",     short: "流星", icon: P + "affiliation_02.png" },
    { id: "5", label: "流星学園附属", short: "付属", icon: P + "affiliation_02.png" },
    { id: "3", label: "守護天使",     short: "天使", icon: P + "affiliation_03.png" },
    { id: "4", label: "ネビュラ", icon: P + "affiliation_04.png" },
    { id: "7", label: "コラプサー",   icon: P + "affiliation_05.png" },
    { id: "8", label: "極星学園",     short: "極星", icon: P + "affiliation_07.png" },
