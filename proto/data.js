...
window.TSF = (function () {
  ...
  const taxonomy = {
    ...
    affiliation: [
      ...
      { id: "6", label: "流星学園附属", icon: P + "affiliation_07.png" },
      { id: "7", label: "極星学園",     icon: P + "affiliation_06.png" },
  ...
  const specialsAlly = [
    ...
    { id: "diff_attr",     label: "異なる属性",              short: "異属性" },
    ...
    { id: "sub_attr",      label: "サブ属性が付与されている", short: "サブ属性中" },
    { id: "same_self_sub", label: "自身のサブ属性と同じ属性", short: "自サブ同属性" },
    { id: "stealth",       label: "ステルス状態",            short: "ステルス" },
    { id: "unison",        label: "ユニゾン参加者",          short: "ユニゾン" },
    { id: "stun_state",    label: "スタン中",                short: "スタン中" },
    { id: "family_bond",   label: "家族の絆が付与されている", short: "家族の絆" },
    /* ▼ 味方の特殊条件を足すならここ */
  ];
  ...
  const effectTypes = [
    ...
    { id: "critical_up",             label: "クリティカルアップ", klass: "buff"   },
    { id: "critical_damage_up",      label: "クリダメアップ",    klass: "buff"   },
    { id: "stun_damage_up",          label: "スタンダメアップ",  klass: "buff"   },
    { id: "barrier",                 label: "バリア",           klass: "buff"   },
    { id: "heal",                    label: "回復",             klass: "buff"   },
    { id: "action_ct_short",         label: "行動CT短縮",       klass: "buff"   },
    { id: "sub_attribute",           label: "サブ属性付与",     klass: "buff"   },
    { id: "damage_taken_up",         label: "被ダメ増加",       klass: "debuff" },
    { id: "special_damage_taken_up", label: "特殊被ダメ増加",    klass: "debuff" },
    { id: "weakness_attribute",      label: "弱点属性付与",     klass: "debuff" },
    { id: "action_control",          label: "行動阻害（スタン等）", klass: "debuff" },
    { id: "status_infliction",       label: "状態付与",         klass: "debuff" },
    { id: "all_attack",              label: "全体攻撃",         klass: "main"   },
    { id: "multi_attack",            label: "多段攻撃",         klass: "main"   },
    { id: "note_backward",           label: "ノーツ後退",       klass: "note"   },
